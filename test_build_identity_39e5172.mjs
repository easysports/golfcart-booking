...
assert.match(html, /Booking v3\.9E\.5\.17\.2/);
assert.match(html, /buildIdentity39E5172\.js/);
assert.match(html, /const PUBLIC_BOOKING_VERSION = '3\.9E\.5\.17\.2'/);
assert.match(html, /ScheduleFleetBuildIdentity39E5172\?\.load\(\{ apiBase: API \}\)/);
assert.match(moduleSource, /const VERSION = "3\.9E\.5\.17\.2"/);
...
assert.equal(context.window.ScheduleFleetBuildIdentity39E5172.VERSION, "3.9E.5.17.2");
...
assert.equal(context.window.__SCHEDULEFLEET_BUILD_IDENTITY__.version, "3.9E.5.17.2");
